...
export default function DataVisualization() {
  ...
  const structuredData = [
    ...
    getBreadcrumbSchema([
      ...
      { name: 'Data Visualization', url: '/services/data-visualization' }
    ]),
    getServiceSchema({
      name: 'Data Visualization & Reporting Services',
      description: PAGE_SEO.services.dataVisualization.description,
  ...
  return (
    <Layout
      title={PAGE_SEO.services.dataVisualization.title}
      description={PAGE_SEO.services.dataVisualization.description}
    >
      <SEOHead
        title={PAGE_SEO.services.dataVisualization.title}
        description={PAGE_SEO.services.dataVisualization.description}
        canonical="/services/data-visualization"
        keywords={PAGE_SEO.services.dataVisualization.keywords}
