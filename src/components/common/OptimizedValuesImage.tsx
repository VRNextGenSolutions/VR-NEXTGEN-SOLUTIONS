...
interface OptimizedValuesImageProps {
  alt?: string;
  width?: number;
  height?: number;
  className?: string;
...
export default function OptimizedValuesImage({
  ...
  return (
    <picture>
      ...
      <source
        srcSet="/images-optimized/Values.avif"
        type="image/avif"
