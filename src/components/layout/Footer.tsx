        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-300">
                <svg className="w-5 h-5 text-gold flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/end-to-end-solutions" className="text-gray-300 hover:text-gold transition-colors text-sm block">
          ...
          {/* Industries */}
          <div>
            <h3 className="text-white font-semibold mb-4 text-lg">Industries</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/industries/pharmaceutical-life-sciences" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Pharmaceutical & Life Sciences
                </Link>
              </li>
              <li>
                <Link href="/industries/manufacturing-engineering" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Manufacturing & Engineering
                </Link>
              </li>
              <li>
                <Link href="/industries/retail-fmcg" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Retail & FMCG
                </Link>
              </li>
              <li>
                <Link href="/industries/healthcare-hospitals" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Healthcare & Hospitals
                </Link>
              </li>
              <li>
                <Link href="/industries/financial-services-insurance" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Financial Services
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/what-we-do" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  What We Do
                </Link>
              </li>
              <li>
                <Link href="/who-we-are" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Who We Are
                </Link>
              </li>
              <li>
                <Link href="/careers" className="text-gray-300 hover:text-gold transition-colors text-sm block">
                  Careers
                </Link>
              </li>
              <li>
