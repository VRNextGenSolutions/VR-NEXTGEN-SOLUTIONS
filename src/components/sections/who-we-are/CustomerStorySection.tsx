  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Story Image */}
        {story.image && (
          <div className="relative w-full h-56 md:h-64 rounded-xl overflow-hidden shadow-sm group-hover:shadow-md transition-shadow duration-300 bg-white border border-gray-100">
            <Image 
              src={story.image} 
